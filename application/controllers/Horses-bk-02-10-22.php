...
#			redirect('bet/hots');
	...
	function set_hist_dia_em_hist(){
		...
		$qr = $this->db->query("select * from cavalos_hist_dia where data_trat >= '".date("2022-09-29")."' AND foi_hist_hist = 0 LIMIT 700");
...
function set_cavalos_dia_em_cavalos(){
		...
		$qr = $this->db->query("select * from cavalos_dia WHERE foi_dia = 0 LIMIT 300");
