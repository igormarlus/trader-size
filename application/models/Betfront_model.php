<?
class Betfront_model extends CI_Model{
			...
			$qr_num = $this->db->query("SELECT * FROM odds_mkt WHERE id_mkt = '".$id_mkt."' AND  selection_id = '".$selecao->selection_id."' AND tipo = '".$side."' "); 	
				...
				if(isset($odds['back'][$selecao->selection_id]) ){
                  ...
                  <div class='row'>  
                    ...
                    <div class='col-sm'> 
                      <strong id='odd_back_".$selecao->selection_id."' class='flipInY animated'>".$odds['back'][$selecao->selection_id]."
                    </strong>
                    </div>
                    <div class='col-sm'>
                      <label id='gap_back_".$selecao->selection_id."'>
                  ...
                  <div class='row'>                    
                    ...
                    <div class='col-sm'> 
                        <label id='percentual_back_".$selecao->selection_id."' style='color:$bg_destaque'> 
                          ".round($pecentual_back,2)."% 
                        </label> 
                    </div>
                    
                    <div class='col-sm'> 
                      <label id='gap_money_back_".$selecao->selection_id."'><i class='fa fa-stop-circle-o'></i></label> 
                    </div>
                  </div>
