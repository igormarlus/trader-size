											...
											<div class="row">
												...
												<div class="col-md-3">
													...
													<div class="tile-box tile-box-alt bg-blue set_odd back" lang="<?=$availableToBack->price;?>" title="<?=$selectionId?>">
														...
														<a href="#" class="tile-footer tooltip-button" data-placement="bottom" title="Soma correspondida dos últimos Preços BACK">
															<? #=$total_size_back?>
												...
												?>
													...
													<div class="col-md-3">
														...
														<div class="tile-box tile-box-alt bg-primary set_odd lay" lang="<?=$availableToLay->price;?>" title="<?=$selectionId?>">
															...
															<a href="#" class="tile-footer tooltip-button" data-placement="bottom" title="Soma correspondida dos últimos Preços Lay">
																<? #=$total_size_lay?>
