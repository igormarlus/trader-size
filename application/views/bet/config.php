...
<title>Config Trader Size </title>
...
//        $('.tb_rel').dataTable();
    ...
    $(document).ready(function() {
        ...
        $("#revoke").click(function(){
           // var txt;
            var r = confirm("Você realmente deseja encerrar a conta?");
            if (r == true) {
               // alert("Já era");
            } else {
               // alert("n confimou");
...
<div id="page-title">
    ...
    <p>Selecione as suas preferências na ferramenta</p>
        ...
        <div class="panel">
            <div class="panel-body">
                ...
                <div class="example-box-wrapper">
					...
					<!----- X ACORDION --> 
                    <br>
                    <form action="<?=base_url()?>bet/set_conf" method="post">
                 	
                    <p align="center"><button type="submit" class="btn btn-primary">Salvar Alterações</button></p>
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered ">
                        ...
                        <tr>
                            ...
                            <th data-class-name="priority">Opção</th>
                            <th>Ativar</th>
                        ...
                        <tbody>
                                ...
                                <? #foreach($this->bet_model->getSoccers_competition_all($APP_KEY, $SESSION_TOKEN); as $dd){ ?>
                                <tr class="odd gradeA">
                                    ...
                                    <td>
                                            ...
                                            <label class="col-sm-6 control-label"></label>
	                                            ...
	                                            <div class="col-sm-6">
                                                    ...
                                                    $where = array('id_user' => $this->session->userdata('id') , 'id_competicao' => $dd->competition->id);
													$this->db->where($where);
													$qr_ver = $this->db->get('bet_competicoes');
													if($dd->graph_odds == 1){ $check = 'checked'; $val_graph_odds = '0'; }else{ $check = ''; $val_graph_odds = '1'; } 
													?>
                                                    <input title="" type="checkbox" <?=$check?> value="1" data-on-color="success" name="graph_odds" class="input-switch check_competition"  data-size="medium" data-on-text="On" data-off-text="Off">
                                    ...
                                    <td>
                                            ...
                                            <label class="col-sm-6 control-label"></label>
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    $this->db->where($where);
                                                    $qr_ver = $this->db->get('bet_competicoes');
                                                    if($qr_ver->num_rows() > 0){ $check = 'checked'; }else{ $check = ''; } */
                                                    ?>
                                                    <input title="" type="checkbox" <? #=$check?> value="<? #=$dd->competition->id?>" data-on-color="success" name="opc2" class="input-switch check_competition"  data-size="medium" data-on-text="On" data-off-text="Off">
                                ...
                                <tr class="odd gradeA">
                                    ...
                                    <td>
                                        ...
                                        Revogar Aplicação. Ecerrar conta no Trader Size
                                    ...
                                    <td>
                                            ...
                                            <label class="col-sm-6 control-label"></label>
                                                ...
                                                <div class="col-sm-6">
                                                   ...
                                                   <a id="revoke" href="<?=base_url()?>bet/revoke" class="">Encerrar Conta</button></a>
...
<script type="text/javascript" src="<?=base_url()?>assets2/widgets/input-switch/inputswitch.js"></script>
<script type="text/javascript">
    /* Input switch */
	...
	$(document).ready(function(){
		$(".check_competition").click(function(){
			var id_evento = $(this).attr('title');
			alert(id_evento);
		})
	})
