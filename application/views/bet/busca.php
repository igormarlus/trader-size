...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="panel">
            <div id="page-title">
                <h2>Busca</h2>
                <p><a href="<?=base_url()?>bet/campeonatos">Acrescente e Remova as competições de acordo com seu planejamento.</a></p>
                    ...
                    <div class="panel-group" id="accordion">
                        ...
                        <div class="panel">
                                <div class="panel-heading">
                                    <h4 class="panel-title title-hero">
                                ...
                                <tbody>
                                <? $t=0;  foreach ($this->bet_model->get_evento_query($APP_KEY, $SESSION_TOKEN,1) as $jogo) { $t++; ?>
