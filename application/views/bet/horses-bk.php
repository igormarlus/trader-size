                ...
                <div class="content-box">
                    ...
                    <div class="panel-group" id="accordion">
                        ...
                        <div class="panel">
                                ...
                                <? #if($meus->num_rows() > 0){ ?>
			                        ...
			                        <? #foreach($meus->result() as $meu){ ?>
                                        ...
                                        <? $t = 0; foreach ($this->bet_model->get_run_Horses($APP_KEY, $SESSION_TOKEN,7) as $jogo) { $t++; ?>
                      ...
                      <div class="panel" style="display:none">
                                ...
                                <tbody>
                                <? /*$t = 0; foreach ($this->bet_model->getHorses($APP_KEY, $SESSION_TOKEN,7) as $jogo) { $t++; ?>
                                <?
							...
							?>
									<tr class="odd gradeA">
										...
										<td>
											<a target='_blank' title="<?=$jogo->event->id?>" href="<?=base_url()?>bet/horse_mkt/<?=$jogo->marketId?>" style="color:#000;font-size:12px">
											<? #=$jogo->event->name?><?=$jogo->event->name?>
											</a>
										</td>
										<td>
										<?
