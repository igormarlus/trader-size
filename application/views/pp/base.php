...
<? include("includes/pp/menu_beto.php"); ?> 
        
        <div id="page-content-wrapper">
            <div id="page-content">
                <? include("includes/pp/header.php"); ?>
            ...
            <div class="panel-content bg-black">
                        <div class="center-vertical">
                            ...
                            <a target="_blank" href="<?=base_url()?>home/cadastro/<?=$this->session->userdata('login')?>" >
                                <?=base_url()?>home/cadastro/<?=$this->session->userdata('id')?>
                            </a>
                            </div>
                        </div>
                </div>
            ...
            <div class="panel-body">
                <h3 class="title-hero">
                 ...
                 <p align="center" style="margin: 3em">
                        ...
                        Eu concordo com os termos de uso do Profit Points
