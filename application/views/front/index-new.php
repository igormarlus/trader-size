...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Trader Size - Corporate Layout 2 | Canvas</title>
		...
		<header id="header">
			...
			<div id="header-wrap">
				...
				<div class="container clearfix">
					...
					============================================= -->
					<div id="logo">
						<a href="<?=base_url()?>" class="standard-logo" data-dark-logo="<?=base_url()?>logo/logo-face.png"><img src="<?=base_url()?>logo/logo-face.png" alt="Canvas Logo"></a>
						<a href="<?=base_url()?>" class="retina-logo" data-dark-logo="<?=base_url()?>logo/logo-dash2.png"><img src="images/logo@2x.png" alt="Canvas Logo"></a>
					</div><!-- #logo end -->
					...
					<nav id="primary-menu" class="sub-title">
						...
						<ul>
							<li class="current"><a href="index.html"><div>Home</div><span>Página Inicial</span></a>
								<ul>
							...
							<li><a href="#"><div>Cadastro</div><span>Comece Agora</span></a>
								<ul>
							...
							<li class="mega-menu"><a href="#"><div>Login</div><span>Templates</span></a>
							...
							<li class="mega-menu"><a href="#"><div>Jogos</div><span>Próximos Jogos</span></a>
								<div class="mega-menu-content style-2 clearfix">
							...
							<li class="mega-menu"><a href="#"><div>Blog</div><span>Novidades</span></a>
								<div class="mega-menu-content style-2 clearfix">
									<ul class="mega-menu-column col-md-3">
							...
							<li><a href="shop.html"><div>Recursos</div><span>Gráfocps, Percentual</span></a>
								<ul>
							...
							<li class="mega-menu"><a href="#"><div>Contato</div><span>Entre em contato</span></a>
						...
						============================================= -->
						<div id="top-cart">
							<a href="#" id="top-cart-trigger"><i class="icon-tag"></i><span>15</span></a>
								...
								<div class="top-cart-items">
									<div class="top-cart-item clearfix">
										...
										<div class="top-cart-item-desc">
											<a href="#">Over 1.5</a>
											<span class="top-cart-item-price">$7981</span>
											<span class="top-cart-item-quantity">89%</span>
										</div>
									</div>
									<div class="top-cart-item clearfix">
										<div class="top-cart-item-image">
										...
										<div class="top-cart-item-desc">
											<a href="#">Chelsea/a>
											<span class="top-cart-item-price">$1565</span>
											<span class="top-cart-item-quantity">89%</span>
										</div>
									</div>
								</div>
								<div class="top-cart-action clearfix">
									<span class="fleft top-checkout-price">$6.5452</span>
									<button class="button button-3d button-small nomargin fright">Ver Mias</button>
								</div>
							</div>
						</div><!-- #top-cart end -->
						...
						<div id="top-search">
							...
							<form action="<?=base_url()?>home/q" method="get">
								<input type="text" name="q" class="form-control" value="" placeholder="Digite o Nome do Time">
							</form>
						</div><!-- #top-search end -->
			...
			<div class="slider-parallax-inner">
				...
				<div class="swiper-container swiper-parent">
					<div class="swiper-wrapper">
						<div class="swiper-slide dark" style="background-image: url('<?php echo base_url()?>conteudo/campo2.jpeg');">
							<div class="container clearfix">
								<div class="slider-caption slider-caption-center">
									<h2 data-caption-animate="fadeInUp" style="color: #000">Bem vindo ao <br> Trader Size </h2>
									<p data-caption-animate="fadeInUp" data-caption-delay="200" style="color:#434343"><strong>Acompanhe os volumes dos mercados <br />através de gráficos atualizados em tempo real,<br> melhorando sua intuição de analisar rapidamente a situação do evento.</strong></p>
								</div>
							</div>
						</div>
						<div class="swiper-slide dark">
							<div class="container clearfix">
								<div class="slider-caption slider-caption-center">
									<h2 data-caption-animate="fadeInUp"> Gráficos e Porcentagem  </h2>
									<p data-caption-animate="fadeInUp" data-caption-delay="200">Confira os percentuais de cada <br> soma das seleções BACK e soma das seleções LAY</p>
								</div>
							</div>
							<div class="video-wrap">
								<video poster="images/videos/explore.jpg" preload="auto" loop autoplay muted>
									<source src='<?php echo base_url()?>conteudo/apresentacao-jogo.mp4' type='video/mp4' />
