...
<head>
	<meta charset="UTF-8">
	<title>Próximos Jogos - Trader Esportivo Futebol - Saiba onde está o dinheiro</title>
    <meta name="title" content="Próximos Jogos - Trader Esportivo Futebol - Saiba onde está o dinheiro" />
    <meta name="description" content="Confira onde está o dinheiro nos próximos jogos de hoje!" />
...
<!-- End Google Tag Manager (noscript) --
	...
	<? if(!isset($_POST['q'])){ ?>	
    <section class="slider9 p05">
		<div class="slider">
		<article>
			<div><div><span class="img-border"><img src="<?=base_url()?>imagens/odds.jpg" alt="Visualização de Odds"> </span></div></div>
			<h3>Visualização de Odds</h3>
			<p>Com um visual simples e intuitivo para sua melhor análise</p>
            <p>Baseada no termo "<strong>Weight of Money</strong>"</p>
			<p><a href="<?=base_url()?>home/cadastro" class="button">Cadastre-se</a> <span class="more"><a href="<?=base_url()?>#recursos">Recursos</a></span></p>
		</article>
		<article>
			<div><div><span class="img-border"><img src="<?=base_url()?>imagens/graficos-odds.png" alt=""></span></div></div>
			<h3>Gráficos</h3>
			<p>Analise o volume de cada selação através de gráficos</p>
			<p><a href="<?=base_url()?>home/cadastro" class="button">Cadastre-se</a> <span class="more"><a href="<?=base_url()?>#recursos">Recursos</a></span></p>
		</article>
		<article>
			<div><div><span class="img-border"><img src="<?=base_url()?>imagens/correspondidos-home.png" alt=""></span></div></div>
			<h3>Mercados Correspondidos</h3>
			<p>Filtre os mercados de acordo com sua preferência</p>
            
			<p><a href="<?=base_url()?>home/cadastro" class="button">Cadastre-se</a> <span class="more"><a href="<?=base_url()?>#recursos">Recursos</a></span></p>
		</article>
		<article>
			<div><div><span class="img-border"><iframe width="745" height="315" src="https://www.youtube.com/embed/myIF4Vn-cAU?rel=0" frameborder="1" allowfullscreen></iframe></span></div></div>
			<h3>Primeiros Passos</h3>
			<p>Confira nosso canal no Youtube.</p>
            <p>Comece agora mesmo a aprender a usar o Trader Size:</p>
			<p><a href="https://www.youtube.com/channel/UCUWiGyIYeL6TMz7ymwuQFCA" class="button">Cadastre-se</a> <span class="more"><a href="https://www.youtube.com/channel/UCUWiGyIYeL6TMz7ymwuQFCA" class="button" target="_blank">Confira nosso canal</a></span></p>
		</article>
        <!--
		<article>
			<div><div><span class="img-border"><img src="<?=base_url()?>images/temp/93-5.jpg" alt=""></span></div></div>
			<h3>Responsive and good looking</h3>
			<p>Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem.</p>
			<p><a href="<?=base_url()?>home/cadastro" class="button">Cadastre-se</a> <span class="more"><a href="<?=base_url()?>#recursos">Recursos</a></span></p>
		</article>-->
		</div>
		<ul class="slider-titles"><li><a href="#">Visualização de Odds</a></li><li><a href="#">Gráficos</a></li><li><a href="#">Correspondidos</a></li><li><a href="#">Primeiros Passos</a></li><!--<li><a href="#">Responsive and good looking</a></li>--></ul>
	</section>
	...
	<section class="content reverse">
        ...
        <section class="columns">
				<h2><span>Search: <strong><?=$_POST['q']?></strong></span></h2>
