								...
								<tr>
									<td>
									  ...
									  <div class="fb-share-button" 
									    data-href="<?=base_url()?>futebol/jogo/<?=url_title($dd_evento->evento)?>/<?=$dd_evento->id_evento?>" 
									...
									<td>
										<h3 style="font-size: 14px">
											<a itemprop="relatedLink" title="<?=$dd_evento->evento?>"  href="<?=base_url()?>futebol/jogo/<?=url_title($dd_evento->evento)?>/<?=$dd_evento->id_evento?>">
												<?=str_replace(" v "," x ",$dd_evento->evento)?>	
											</a>
										</h3>
									</td>
									...
									<td>
										...
										<a itemprop="relatedLink" title="<?=$dd_evento->id_evento?>" href="<?=base_url()?>bets/jogo/<?=url_title($dd_evento->evento)?>/<?=$dd_evento->id_evento?>" class="btn btn-success">Veja Mais</a>
