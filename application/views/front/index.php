...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Trader Size | Foco no Volume</title>
		...
		<header id="header" class="full-header dark">
			...
			<div id="header-wrap">
				...
				<div class="container clearfix">
					...
					============================================= -->
					<div id="logo">
						<a href="<?=base_url()?>" class="standard-logo" data-dark-logo="<?=base_url()?>logo/logo-face.png"><img src="<?=base_url()?><?=base_url()?>logo/logo-face.png" alt="Trader Size"></a>
					...
					<nav id="primary-menu">
						...
						<ul>
							...
							<li class="current"><a href="#"><div>Quem Somos</div></a></li>
							<li class="mega-menu"><a href="#"><div>Recursos</div></a>
								<ul>
									<li><a href="<?=base_url()?>"><div>Mercados</div></a></li>
                                    <li><a href="<?=base_url()?>"><div>Hots</div></a></li>
                                    <li><a href="<?=base_url()?>"><div>Correspondidos</div></a></li>
                                    <li><a href="<?=base_url()?>"><div>Gráficos</div></a></li>
                                    <li><a href="<?=base_url()?>"><div>Volume em Percentual</div></a></li>
								</ul>
							</li>
							<li class="mega-menu" style="display:none"><a href="#"><div>Portfolio</div></a>
							...
							<li class="mega-menu"><a href="<?=base_url()?>home/cadastro"><div>Cadastro</div></a>
								
							</li>
							<li><a href="shop.html"><div>Adesão</div></a>
								
							</li>
							<li><a href="#"><div>Contato</div></a></li>
						</ul>
								...
								<div class="top-cart-items">
									<div class="top-cart-item clearfix">
										<div class="top-cart-item-image">
											<a href="#"><img src="<?=base_url()?>images/shop/small/1.jpg" alt="Blue Round-Neck Tshirt" /></a>
										</div>
									...
									<div class="top-cart-item clearfix">
										<div class="top-cart-item-image">
											<a href="#"><img src="<?=base_url()?>images/shop/small/6.jpg" alt="Light Blue Denim Dress" /></a>
										</div>
										<div class="top-cart-item-desc">
						...
						<div id="top-search">
							...
							<form action="<?=base_url()?>bet/busca" method="post">
								<input type="text" name="q" class="form-control" value="" placeholder="Buscar Evento..">
							</form>
						</div><!-- #top-search end -->
			...
			<div class="slider-parallax-inner">
				...
				<div class="swiper-container swiper-parent">
					<div class="swiper-wrapper">
						<div class="swiper-slide dark" style="background-image: url('<?=base_url()?>conteudo/banner-copa.jpg');">
							<div class="container clearfix">
								<div class="slider-caption slider-caption-center">
									<!--
									<h2 data-caption-animate="fadeInUp">Trader Size</h2>
                                    <h2 data-caption-animate="fadeInUp">Bem vindo</h2>
									<p data-caption-animate="fadeInUp" data-caption-delay="200" style="color:#000">Acompanhe os volumes dos mercados através de gráficos atualizados em tempo real.</p>
									-->
								</div>
							</div>
						</div>
						<div class="swiper-slide dark">
							...
							<div class="video-wrap">
								<video poster="<?=base_url()?>videos/explore.jpg" preload="auto" loop autoplay muted>
									<source src='<?=base_url()?>videos/correspondido.mp4' type='video/mp4' />
									<source src='<?=base_url()?>videos/explore.webm' type='video/webm' />
								</video>
								<div class="video-overlay" style="background-color: rgba(0,0,0,0.55);"></div>
							</div>
						</div>
						<div class="swiper-slide" style="background-image: url('<?=base_url()?>images/slider/swiper/3.jpg'); background-position: center top;">
							<div class="container clearfix">
			...
			<div class="content-wrap">
				...
				<div class="container clearfix">
					...
					<div id="oc-clients-full" class="owl-carousel image-carousel carousel-widget" data-margin="30" data-nav="false" data-loop="true" data-autoplay="5000" data-pagi="false" data-items-xxs="2" data-items-xs="3" data-items-sm="4" data-items-md="5" data-items-lg="6">
						...
						<a href="#"><img src="<?=base_url()?>images/clients/1.png" alt="Clients"></a>
						<a href="#"><img src="<?=base_url()?>images/clients/2.png" alt="Clients"></a>
						<a href="#"><img src="<?=base_url()?>images/clients/3.png" alt="Clients"></a>
						<a href="#"><img src="<?=base_url()?>images/clients/4.png" alt="Clients"></a>
						<a href="#"><img src="<?=base_url()?>images/clients/5.png" alt="Clients"></a>
						<a href="#"><img src="<?=base_url()?>images/clients/6.png" alt="Clients"></a>
						<a href="#"><img src="<?=base_url()?>images/clients/7.png" alt="Clients"></a>
						<a href="#"><img src="<?=base_url()?>images/clients/8.png" alt="Clients"></a>
						<a href="#"><img src="<?=base_url()?>images/clients/9.png" alt="Clients"></a>
						<a href="#"><img src="<?=base_url()?>images/clients/10.png" alt="Clients"></a>
						<a href="#"><img src="<?=base_url()?>images/clients/11.png" alt="Clients"></a>
						<a href="#"><img src="<?=base_url()?>images/clients/12.png" alt="Clients"></a>
					...
					<div class="col_two_third">
						...
						<div class="col_one_third">
							...
							<div class="widget clearfix">
								...
								<div style="background: url('<?=base_url()?>images/world-map.png') no-repeat center center; background-size: 100%;">
									<address>
