              ...
              <div class="card my-1 slideInIp animated">
                ...
                <div class="card-header zoomIn animated">
                  <ul class="nav nav-tabs card-header-tabs">
                    <li class="nav-item">
                      <a class="nav-link active" href="#" id="tit_mkt_now" style="font-weight: bold;"> BOT A2</a>
                    </li>
                    <? if($status == '0'){ ?>
                    <li class="nav-item">
                      <a class="nav-link " href="<?=base_url()?>futebol/hots/2/1" id="tit_mkt_now" style="font-weight: bold;"> <span class="label label-success"></span>Ir para Fechados</a>
                    </li>

                    <? } ?>
                    <? if($status == '1'){ ?>
                    <li class="nav-item">
                      <a class="nav-link " href="<?=base_url()?>futebol/hots/2/0" id="tit_mkt_now" style="font-weight: bold;"> <span class="label label-warning"></span>Ir para Abertos</a>
                    </li>
