				...
				FB.ui(
					{
					  ...
					  link: '<?=base_url()?>',
					  picture: '<?=base_url()?>assets2/images/login-bg.png',
...
<meta property="og:title"              content="GO7Busness" />
<meta property="og:description"        content="Descrição asd" />
<meta property="og:image"              content="<?=base_url()?>assets2/images/login-bg.png" />
...
<div id="page-title">
    ...
    <p>Acompanhe em tempo real, semanalmente nossas estratégias no Bf Bot Manager.</p>
    ...
    <div class="col-md-8">
        ...
        <div class="panel">
            <div class="panel-body">
                <h3 class="title-hero">
                    Transmissão AO-VIVO - Go7Business
                </h3>
                ...
                <div class="box">
                   ...
                   <iframe width="560" height="315" src="https://www.youtube.com/embed/5SCPhkC0AoA" frameborder="0" ></iframe>
                
                <a id="check" class="btn" style="display:">Compartilhar</a>
                </div>
