...
<title>Trader Size - Back Office</title>
...
<? include("includes/dash/menu_beto.php"); ?> 
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <a href="#" title="Example tile shortcut" class="tile-box tile-box-shortcut btn-success">
                    <div class="tile-header" style="font-size:12px">
                        Pontos<br>
                        0
                    </div>
                    <div class="tile-content-wrapper">
            ...
            <div class="col-md-3">
                <a href="#" title="Example tile shortcut" class="tile-box tile-box-shortcut btn-info">
                    <span class="bs-badge badge-absolute">0</span>
                    <div class="tile-header">
                        Cadastros 
                    </div>
                    <div class="tile-content-wrapper">
        ...
        <div class="panel-body">
            <div class="panel-content bg-black">
                        <div class="center-vertical">
                            ...
                            <a target="_blank" href="<?=base_url()?>home/cadastro/<?=$this->session->userdata('login')?>" >
            ...
            <div class="panel-body">
                <h3 class="title-hero">
                 ...
                 <p align="center" style="margin: 3em">
                        ...
                        Entradas automaticamentes dentre um padrão de configuranção buscando a maior margem de segurança podendo ser lucrativo ou não, ao clicar e marcar no botão startar robô você esta ciente de todos os riscos.

                       
                            <br><br>
                            <button value="1" class="btn btn-success">Ativar</button>
                ...
                <div class="example-box-wrapper">
                    <div id="data-example-1" class="mrg20B">
                       <p align="center"><img src="<?=base_url()?>imagens/dash-ex-g.jpg"></p> 
                    </div>
