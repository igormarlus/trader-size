        ...
        <div class="panel">
            ...
            <? if($cb == 'transfok'){ ?>
            		<div class="alert alert-success">
                        ...
                        <div class="alert-content">
                            <h4 class="alert-title">Envio realizado com sucesso!</h4>
                            <p>Confira o histórico no <a href="<?=base_url()?>dash/financeiro">Relatório Financeiro</a></p>
                        </div>
                    </div>
            <? } ?>
            ...
            <? if($cb == 'err1'){ ?>
		            <div class="alert alert-danger">
                        ...
                        <div class="alert-content">
                            <h4 class="alert-title">Falha no envio!</h4>
            ...
            <div class="alert alert-success">
                ...
                <div class="panel-body">
	                ...
	                <form action="<?=base_url()?>financeiro/set_trans" method="post">
                <input type="hidden" value="<?=$this->session->userdata('id')?>" name="de" id="de" class="text" />
                    ...
                    <div class="form-group">
                        <label class="control-label">Para (Login):</label>
                        <div class="">
                    ...
                    <div class="form-group">
                        <label class="control-label">Senha de Segurança (<a href="<?=base_url()?>dash/minha_conta">Alterar</a>):</label>
                        <div class="">
...
<script type="text/javascript">
    $(document).ready(function() { 
	//alert("1");
		$("#valor").maskMoney({symbol:'R$ ', showSymbol
		:true, thousands:'.', decimal:',', symbolStay: true});
