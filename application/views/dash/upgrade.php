        ...
        <div class="panel">
			...
			if($dd->plano > 0){
				foreach($planos->result() as $plano){ 
					...
					if($plano->id == $dd->plano){ $atual = "green"; }else{ $atual = 'blue'; }
				?>
                            <div class="col-md-3">
                                <div class="pricing-box content-box">
                                    <h3 class="bg-black pricing-title"><?=$plano->nome?></h3>
                                    <div class="bg-<?=$atual?> pricing-specs">
                                        <span><sup>$</sup><?=$plano->valor?></span>
                                        <i>Por Ano</i>
                                    </div>
                                    <ul>
                                        <li><?=$plano->nome?></li>
                                        ...
                                        <li><?=$plano->pagamento_semanal?></li>
                                        <li><?=$plano->ganho?>% Ganho binário</li>
                                    </ul>
                                    <div class="pad25A">
                                    ...
                                    <? if($dd->plano < $plano->id){ ?>
                                        ...
                                        ?>
                                            ...
                                            <a href="<?=base_url()?>dash/set_plano/<?=$plano->id?>" class="btn btn-lg text-transform-upr btn-black font-size-12" title="">Upgrade</a>
                                        <? }else{ ?>`
                ...
                <div class="col-md-3">
                    <div class="pricing-box content-box">
                        <h3 class="bg-black pricing-title">Silver</h3>
                        <div class="bg-yellow pricing-specs">
                        ...
                        <div class="pad25A">
                            <a href="#" class="btn btn-lg text-transform-upr btn-black font-size-12" title="">Sign Up Now!</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="pricing-box content-box">
                        <h3 class="bg-black pricing-title">Gold</h3>
                        <div class="bg-orange pricing-specs">
                            <span><sup>$</sup>299</span>
                            <i>Once per month</i>
                        </div>
                        <ul>
                ...
                <div class="col-md-3">
                    <div class="pricing-box content-box">
                        <h3 class="bg-black pricing-title">Platinum</h3>
