...
<div class="row">
    <div class="col-md-12">
        ...
        <? $total = 0;  foreach($bonus->result() as $bon){  ?>
        <? if($bon->id_user == $this->session->userdata('id')){ $total +=  $bon->valor; ?>
        <tr class="odd gradeA">
            ...
            <td class="center">
            <? if($bon->id_user == $this->session->userdata('id')){ ?>
	            <strong style="color:green">R$ <?=number_format($bon->valor, 2, ',', '.');?></strong>
            <? } ?>
            <? if($bon->id_user_mov == $this->session->userdata('id')){ ?>
	            <strong style="color:red">R$ <?=number_format($bon->valor, 2, ',', '.');?></strong>
            <? } ?>
            </td>
        ...
        <tr class="gradeU">
            ...
            <td>-</td>
            <td>-</td>
            <td class="center"><strong style="color:black"> R$ <?=number_format($total, 2, ',', '.');?></strong></td>
