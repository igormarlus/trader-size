...
<title>Trader Size - Perfil</title>
...
<div class="row">
    <div class="col-md-8">
        ...
        <div class="panel">
            ...
            <div class="panel-body">
            <form class="form-horizontal bordered-row" action="<?=base_url()?>dash/set_perfil" method="post" id="set_perfil">
                
                
                
                
                <div class="form-group">
                    <label class="col-sm-3 control-label">Enviar Foto</label>
                    <div class="col-sm-6">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control" type="password" placeholder="Confirmar Senha de Segurança" id="senha_seguranca_confirm" name="senha_seguranca_confirm" value="">
                                </div>
