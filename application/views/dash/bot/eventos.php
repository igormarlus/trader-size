...
<div class="row">
    <div class="col-md-8">
        ...
        <div class="panel">
            ...
            <form class="form-horizontal bordered-row" action="<?=base_url()?>bot/cadastrar" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <select class="form-control" name="status">
                            ...
                            <option value="SETELED">SETELED</option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input class="form-control" title="Evento" name="evento" type="text" placeholder="Evento 00:00 Titulo\00th\1m44Hcap\horse">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input class="form-control" title="P/L" name="valor" id="valor" type="text" placeholder="0.00">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input class="form-control" title="Evento" name="bet_placed" type="text" placeholder="aaaa-mm-dd 00:00:00">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input class="form-control" title="Evento" name="bet_id" type="text" placeholder="65465465465465465465">
                    </div>
                </div>
            ...
            <div class="example-box-wrapper">
                ...
                <? foreach($eventos->result() as $eve){ ?>
                <tr class="odd gradeA">
                    
                    
                    <td>
                    <a href="<?=base_url()?>bot/evento_edit/<?=$eve->id?>">
						<?=$eve->evento?>
                    </a>    
                    </td>
                    <td class="center"><?=$eve->status?></td>
