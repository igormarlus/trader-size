...
<div class="row">
    <div class="col-md-8">
        ...
        <div class="panel">
            ...
            <? $eve = $this->padrao_model->get_by_id($id_evento,'bot_eventos')->row(); ?>
            <form class="form-horizontal bordered-row" action="<?=base_url()?>bot/edit/<?=$id_evento?>" method="post">
                
                <div class="form-group">
                    <label class="col-sm-3 control-label">Status.</label>
                    <div class="col-sm-6">
                        <select class="form-control" name="status">
                        	<?php if($eve->status == 'SETELED'){ $check = "selected"; }else{ $check = ''; }?>
                            <option <?=$check?> value="SETTLED">SETTLED</option>
                            <?php if($eve->status == 'MATCHED'){ $check = "selected"; }else{ $check = ''; }?>
                            <option <?=$check?> value="MATCHED">MATCHED</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input class="form-control" title="Evento" value="<?=$eve->evento?>" name="evento" type="text" placeholder="Evento 00:00 Titulo\00th\1m44Hcap\horse">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input class="form-control" title="P/L" name="valor" id="valor" type="text" value="<?=number_format($eve->matched, 2, ',', '.')?>" placeholder="0.00">
                    </div>
                </div>
                
                <div class="form-group">
                    <label class="col-sm-3 control-label">Bet Placed</label>
                    <div class="col-sm-6">
                        <input class="form-control" title="Evento" name="bet_placed" type="text" value="<?=$eve->bet_placed?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input class="form-control" title="Evento" name="bet_id" type="text" value="<?=$eve->bet_id?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input class="form-control" title="Evento" name="red" type="checkbox" value="1">
                    </div>
                </div>
