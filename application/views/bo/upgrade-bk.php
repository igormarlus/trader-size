                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 col-md-4">
                                            <div class="pricing-col <?=$atual?>">
                                                <div class="pricing-header">
                                                    <div class="pricing-title">Plano</div><!-- /.pricing-title -->
                                                    <div class="pricing-value">$ 100</div><!-- /.pricing-value -->
                                                    <div class="pricing-duration">por ano</div><!-- /.pricing-duration -->
                                
                                                    <a href="<?=base_url()?>dash/set_plano" class="btn">UPGRADE</a>
                                                </div><!-- /.pricing-header -->
                                
                                                <div class="pricing-content">
                                                    <ul>
                                                        <li>100 pagamentos</li>
                                                        <li>10 Cursos</li>
                                                        <li>bônus Indi.</li>
                                                    </ul>
                                                </div><!-- /.pricing-content -->
                                        ...
                                        <div class="col-sm-6 col-md-4">
                                            <div class="pricing-col">
                                                <div class="pricing-header">
                                                    <div class="pricing-title">Prata</div><!-- /.pricing-title -->
                                                    <div class="pricing-value">$ 200</div><!-- /.pricing-value -->
                                                    <div class="pricing-duration">por ano</div><!-- /.pricing-duration -->
                                        ...
                                        <div class="col-sm-6 col-md-4">
                                            <div class="pricing-col">
                                                <div class="pricing-header">
                                                    <div class="pricing-title">Ouro</div><!-- /.pricing-title -->
                                                    <div class="pricing-value">$ 250</div><!-- /.pricing-value -->
                                                    <div class="pricing-duration">por ano</div><!-- /.pricing-duration -->
