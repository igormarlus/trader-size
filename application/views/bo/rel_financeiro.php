                ...
                <div class="admin-content-main">
                    <div class="admin-content-main-inner">
                        <div class="container-fluid">
                                <div class="box">
                                	<h1 class="page-header mb60">Relat&oacute;rio de Financeiro</h1>
    
   								<? if($bonus->num_rows() == 0){ ?>
                                	<h3 class="page-header mb60">Nenhum valor registrado</h3>
                                <? }else{ ?>
                                ...
                                <table class="table table-simple">
                                    ...
                                    <tbody>
                                    <? $total = 0;  ?>
                                    	<? foreach($bonus->result() as $dd_bonus){ $total += $dd_bonus->valor; ?>
                                    		<tr>                                            
												...
												<? if($dd_bonus->status == '1'){ ?>
                                                	<span style="color:blue">$ <?=number_format($dd_bonus->valor, 2, ',', '.') ?>                                 
                                                <? }else{ ?>
                                                	 # <?=number_format($dd_bonus->valor, 2, ',', '.') ?>                                   
                                                <? } ?>
