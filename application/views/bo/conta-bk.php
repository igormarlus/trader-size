                ...
                <div class="admin-content-main">
                    <div class="admin-content-main-inner">
                        ...
                        <form action="<?=base_url()?>dash/set_perfil" method="post" id="set_perfil">
                                ...
                                <ul>
                                	<? if($dd->lado == 'e'){ $check = "checked"; }else{ $check = ''; }?>
                                    <li><label><input type="radio" name="lado" value="e" <?=$check?> style="border:#09f 1px solid;width:80px;height:80px;display:block;clear:both" > Esquerda</label></li>
                                    <? if($dd->lado == 'd'){ $check = "checked"; }else{ $check = ''; }?>
                                    <li><label><input type="radio" name="lado" value="d" <?=$check?> style="border:#09f 1px solid;width:80px;height:80px;display:block;clear:both" > Direita</label></li>
                                ...
                                <div class="form-group">
                                    <input class="form-control" name="login" disabled placeholder="login" value="<?=$dd->login?>" />
                                </div><!-- /.form-group -->
                                <div class="form-group">
                                    <input class="form-control" name="nome" type="text" placeholder="Nome" value="<?=$dd->nome?>">
                                </div><!-- /.form-group -->
                            
                                <div class="form-group">
                                    <input class="form-control" name="email" disabled placeholder="E-mail" value="<?=$dd->email?>" />
                                </div><!-- /.form-group -->
                                <div class="form-group">
                                    <input class="form-control" id="cpf" name="cpf" disabled placeholder="CPF" value="<?=$dd->cpf?>" />
                                </div><!-- /.form-group -->
                                
                                <div class="form-group">
                                    <input class="form-control" name="dt_nascimento" id="dt_nascimento" placeholder="Data de Nascimento" value="<?=$this->padrao_model->converte_data($dd->dt_nascimento)?>" />
                                </div><!-- /.form-group -->
                                
                                <div class="form-group">
                                    <input class="form-control" id="telefone" name="telefone" placeholder="Telefone" value="<?=$dd->telefone?>" />
                                </div><!-- /.form-group -->
    ...
    <div class="col-sm-12">
        ...
        <h3 class="page-header">Endereço</h3>    
            ...
            <div class="row">
             ...
             <div class="row">
             <h2 class="page-header" id="senha2">Senha de Segurança</h2>
                <div class="col-sm-6">
                    <div class="input-group">
