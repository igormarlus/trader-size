...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="panel">
            ...
            <div class="panel-body">
            <form class="form-horizontal bordered-row" action="<?=base_url()?>eletronicgames/set_jogador" method="post" id="">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input class="form-control" title="Nome do Jogador" name="jogador" type="text" placeholder="Nome do Jogador" value="<?=$dd->nome?>">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label">Abreviação: </label>
                    <div class="col-sm-6">
                        <input class="form-control" title="Abreviação" name="time" type="text" placeholder="Time do Jogador" value="<?=$dd->nome?>">
                    </div>
                </div>
        ...
        <div class="panel">
            <div class="panel-body">
                ...
                <? foreach($meus->result() as $jog){ ?>
                <tr class="odd gradeA">
                    
                    <td><?=$jog->jogador?></td>
                    <td><?=$jog->time?></td>
                    <td><?=$this->padrao_model->converte_data(substr($jog->dt,0,10))?></td>
