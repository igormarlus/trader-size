...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="panel">
            ...
            <div class="panel-body">
            <form class="form-horizontal bordered-row" action="<?=base_url()?>eletronicgames/set_partida" method="post" id="">
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label">Jogador HOME </label>
                    <div class="col-sm-6">
                        <select class="form-control" title="Jogador HOME" name="id_jogador_home">
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label">Jogador AWAY </label>
                    <div class="col-sm-6">
                        <select class="form-control" title="Jogador HOME" name="id_jogador_away">
                            <? foreach($meus->result() as $meu){ ?>
                                <option value="<?=$meu->id?>"><?=$meu->jogador?> (<?=$meu->time?>)</option>
                            <? } ?>
                        </select>
            ...
            <!--
                <div class="form-group">
                    <label class="col-sm-3 control-label">Vencedor </label>
                    <div class="col-sm-6">
                        <select class="form-control" title="Jogador HOME" name="id_vencedor">
                            <? foreach($meus->result() as $meu){ ?>
                                <option value="<?=$meu->id?>"><?=$meu->jogador?> (<?=$meu->time?>)</option>
                            <? } ?>
                        </select>
            ...
            -->
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="col-sm-5">
                            <input class="form-control" style="width: 100%;text-align: center;" title="Gols CASA" name="gol_home" type="number" placeholder="GOLS Casa" value="">
                        </div>
                        <div class="col-sm-2">
                            <strong>X</strong> 
                         </div>
                         <div class="col-sm-5">
                            <input class="form-control" style="width: 100%;text-align: center;" title="Gols FORA" name="gol_away" type="number" placeholder="GOLS Fora" value="">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-sm-6">
                        <button class="btn btn-secundary" type="submit" >Salvar </button>
                    </div>
                </div>
        ...
        <div class="panel">
            <div class="panel-body">
                ...
                <tr class="odd gradeA">
                    ...
                    <td><?=$this->padrao_model->get_by_id($par->id_jogador_home,'EG_jogadores')->row()->jogador?></td>
                    <td><?=$this->padrao_model->get_by_id($par->id_jogador_home,'EG_jogadores')->row()->time?></td>

                    <td><?=$this->padrao_model->get_by_id($par->id_jogador_away,'EG_jogadores')->row()->jogador?></td>
                    <td><?=$this->padrao_model->get_by_id($par->id_jogador_away,'EG_jogadores')->row()->time?></td>

                    <td><strong><?=$this->padrao_model->get_by_id($par->id_vencedor,'EG_jogadores')->row()->jogador?></strong></td>
