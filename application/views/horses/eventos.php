...
<!--CARD MODELO -->
              ...
              <div class="card my-1 slideInIp animated">
                ...
                <div class="card-header zoomIn animated">
                  <ul class="nav nav-tabs card-header-tabs">
                    <li class="nav-item">
                      <a class="nav-link active" href="#" id="tit_mkt_now" style="font-weight: bold;">Próximas Corridas mais correspondidas </a>
                    </li>
                  </ul>
                </div>
            ...
            $posicao = 0; foreach($this->betfront_model->getMarketings_best($APP_KEY, $SESSION_TOKEN,7,50,'') as $dd){ $posicao++; 
              //print_r($dd);
                  ...
                  <? 
                    ...
                    <tr class="bounceInUp animated" style="width: 100%;">
                      <td>
                        <a  class='clique'   href="<?=base_url()?>corridasdecavalos/corrida/<?=url_title($time->runnerName)?>/<?=$dd->marketId?>" itemprop="relatedLink" id="eve<?=str_replace(".","",$dd->marketId)?>"  title="<?=$times[1]?> x <?=$times[2]?>" target="_blank">
