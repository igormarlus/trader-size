            ...
            <div class="dropdown-menu float-left">
                <div class="box-sm">
                    ...
                    <div class="pad5T pad5B pad10L pad10R dashboard-buttons clearfix">
                        ...
                        <a href="<?=base_url()?>bet/hots" class="btn vertical-button remove-border btn-danger" title="">
                            <span class="glyph-icon icon-separator-vertical pad0A medium">
                                <i class="glyph-icon icon-tags opacity-80 font-size-20"></i>
                            </span>
                            Mercados
        ...
        <div class="dropdown" id="notifications-btn">
            ...
            <div class="dropdown-menu box-md float-left">
                ...
                <div class="scrollable-content scrollable-slim-box">
					...
					$qr_selecao_not = mysql_query("SELECT * FROM odds_mkt WHERE id_mkt = '".$dd_not->id_mkt."' AND selection_id = '".$dd_not->selection_id."' ORDER BY id desc LIMIT 1");
                    $hot_selecao_not = mysql_fetch_assoc($qr_selecao_not);
					?>
                        <li>
            ...
            <div class="dropdown-menu pad0A box-sm float-left" id="progress-dropdown">
                <div class="scrollable-content scrollable-slim-box">
                    <ul class="no-border progress-box progress-box-links">
                        ...
                        <li>
                            <a href="#" title="Exposto">
                                <div class="progress-title">
                                    Exposto
                                    <br>
                                    <b><?=abs($fundos->exposure)?></b>
                                </div>
                                <div class="progressbar-smaller progressbar" data-value="<?=$fundos->exposure?>">
                        ...
                        <li>
                            <a href="#" title="Comissão Retida">
                                <div class="progress-title">
                                    Alvo dia
                                    <?
                                    $alvo_dia = $fundos->availableToBetBalance * 0.03 + ($fundos->availableToBetBalance) ;
									?>
                                    <b><?=$alvo_dia?><? #=$fundos->retainedCommission?></b>
                                </div>	
                            <div class="progressbar-smaller progressbar" data-value="<?=$alvo_dia?>">
                                    <div class="progressbar-value bg-blue"></div>
                                </div>
                            </a>
                        </li>
