...
<div id="page-sidebar">
	...
	if($this->uri->segment(2) == 'betjogo' || $this->uri->segment(2) == "bet"){ 
	?>
    <li >
        <a href="javascript:void(0);" title="Mercados">
            <i class="glyph-icon icon-tag"></i>
            <span style="color: #ffb80c">Mercados</span>
        </a>
        <?  $modo_atual = ""; if($this->uri->segment(2) == "betjogo" || $this->uri->segment(2) == "bet"){ $modo_atual = $this->uri->segment(5); ?>
                	...
                	<? $dd = 0;
						...
						*/
                                ...
                                <li style="list-style:none;list-style:none !important;list-style:none;margin:0px 0px 0px 0px">
                                    ...
                                    <a class="sf-with-ul" style="font-size:11px;margin:0px 0px 0px 0px" href="<?=base_url()?>bet/betjogo/<?=$id_jogo?>/<?=$jogo->marketId?><? #=$modo_atual?>" title="<?=$jogo->marketId?>">
                                    <?
                                    // class favoritos
                                    ...
                                    <i class="glyph-icon <?=$class_fav?> favoritar" title="<?=$jogo->marketId?>"></i>
                                        ...
                                        <span title="<?=$jogo->marketName?>">
                                            <? if(strlen($jogo->marketName) < 20 ){ ?>
                                                <?=$jogo->marketName?>
                                            <? }else{ ?>
                                                <?=substr($jogo->marketName,0,20)?>
                                            <? } ?>
                                        ...
                                        // bg
                                        $bg_corres =  'danger';
                                        if($jogo->totalMatched > 50000){ $bg_corres =  'success'; }  
                                        ?>
                                        <span class="bs-badge badge-<?=$bg_corres?>" style="text-align:left;float:right"><?=number_format($jogo->totalMatched, 2, ',', '.');?> </span>
                                    </a>
   ...
   <!-- <li>
        <a href="<?=base_url()?>horse" title="Horses" style="">
    ...
    <li>
        ...
        <div class="sidebar-submenu">
            ...
            <ul>
                ...
                <li>
                    <a href="<?=base_url()?>dash/mkts" title="Marketings" target="_blank">
                        Marketings Abertos
                    </a>
                </li>
                <li>
                    <a href="<?=base_url()?>cron/get_soccer" title="Usuários Cadastrados" target="_blank">
                        Get Jogos
                    </a>
                </li>
                <li>
    ...
    <li>
        ...
        <li>
        <a href="<?=base_url()?>bet/campeonatos" title="GET ODDS A2">
            <i class="glyph-icon icon-mail-reply-all"></i>
            <span>GET ODDS A2</span>
        </a>
        <div class="sidebar-submenu">
            ...
            <ul>
                ...
                <li>
                    <a href="<?=base_url()?>botbet/get_odd_a2/0" title="Pegar Mercados" target="_blank">
                        MATCH_ODDS
                    </a>
                </li>
                
                <li>
                    <a href="<?=base_url()?>botbet/get_odd_a2/101" title="Pegar Mercados" target="_blank">
                        DRAW_NO_BET
                    </a>
                </li>
                
                <li>
                    <a href="<?=base_url()?>botbet/get_odd_a2/121" title="Pegar Mercados" target="_blank">
                        CORRECT_SCORE
                    </a>
                </li>
                
                <li>
                    <a href="<?=base_url()?>botbet/get_odd_a2/05" title="Pegar Mercados" target="_blank">
                        OVER_UNDER_05
                    </a>
                </li>
                <li>
                    <a href="<?=base_url()?>botbet/get_odd_a2/005" title="Pegar Mercados" target="_blank">
                        FIRST_HALF_GOALS_05
                    </a>
                </li>
                <li>
                    <a href="<?=base_url()?>botbet/get_odd_a2/015" title="Pegar Mercados" target="_blank">
                        FIRST_HALF_GOALS_15
                    </a>
                </li>
                
                <li>
                    <a href="<?=base_url()?>botbet/get_odd_a2/" title="Pegar Mercados" target="_blank">
                        OVER_UNDER_15
                    </a>
                </li>
                <li>
                    <a href="<?=base_url()?>botbet/get_odd_a2/2" title="Pegar Mercados" target="_blank">
                        OVER_UNDER_25
                    </a>
                </li>
                <li>
                    <a href="<?=base_url()?>botbet/get_odd_a2/3" title="Pegar Mercados" target="_blank">
                        OVER_UNDER_35
                    </a>
                </li>
                <li>
                    <a href="<?=base_url()?>botbet/get_odd_a2/4" title="Pegar Mercados" target="_blank">
                        OVER_UNDER_45
                    </a>
                </li>
                <li>
                    <a href="<?=base_url()?>botbet/get_odd_a2/11" title="Pegar Mercados" target="_blank">
                        BOTH_TEAMS_TO_SCORE
                    </a>
                </li>
    ...
    <li >
        <a href="javascript:void(0);" title="Mercados">
            <i class="glyph-icon icon-tag"></i>
            <span style="color: #ffb80c">Markets</span>
        </a>
        <?  $modo_atual = ""; if($this->uri->segment(2) == "betjogo" || $this->uri->segment(2) == "bet"){ $modo_atual = $this->uri->segment(5); ?>
            <div class="sidebar-submenu" style="display:block">
...
$(document).ready(function(){
	<? if($this->uri->segment(2) == "betjogo"){ ?>
		$(".sidebar-submenu").attr("style","display:block");
	<? } ?>
})
</script>
<script>
